...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    . organizations/fabric-ca/registerEnroll-new.sh
  ...
  while :
    ...
    infoln "Creating Org1-3 Identities"
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf addOrgn/fabric-ca/orgn/msp addOrgn/fabric-ca/orgn/tls-cert.pem addOrgn/fabric-ca/orgn/ca-cert.pem addOrgn/fabric-ca/orgn/IssuerPublicKey addOrgn/fabric-ca/orgn/IssuerRevocationPublicKey addOrgn/fabric-ca/orgn/fabric-ca-server.db'
...
COMPOSE_FILE_BASE=docker/docker-compose-data-net.yaml
# docker-compose.yaml file if you are using couchdb
COMPOSE_FILE_COUCH=docker/docker-compose-couch.yaml
# certificate authorities compose file
COMPOSE_FILE_CA=docker/docker-compose-ca.yaml
# use this as the docker compose couch file for org4
COMPOSE_FILE_COUCH_ORG4=addOrgn/docker/docker-compose-couch-org4.yaml
# use this as the default docker-compose yaml definition for org4
COMPOSE_FILE_ORG4=addOrgn/docker/docker-compose-org4.yaml
#
