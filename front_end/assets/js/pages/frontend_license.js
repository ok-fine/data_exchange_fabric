...
jQuery(function(){ 
    ...
    $('#btn-apply').click(function(){
        ...
        if( jQuery('.js-validation-material').valid()){
            ...
            $.ajax({
                // url: 'http://localhost:8088/client/commercial/apply',
                url: '/client/commercial/apply',
                crossDomain: true,
                type: 'post',
                ...
                success: function (data) {
                    ...
                    if(data.code === '200'){
                        ...
                        alert(`${name} 执照申请成功`);
                        // location.href = `${URL}/frontend_license.html`;
                        location.href = 'frontend_license.html';
